/*****************************************************************************************/
/* This is the first of two SAS Scripts needed to prepare the 2021 National YRBS dataset */
/* for analysis in the SOGI Project (SM Goodreau, MP Barry). These files must be run in  */
/* sequence. The next file is named "2021 YRBS SAS Input.sas"                            */
/*                                                                                       */
/*                                   *** BEFORE RUNNING ***                              */
/*  Change the file location specification from 'H:\mpbarry\data' to the location where  */
/*  you want the format library to be stored before you run this program. Do this by     */
/*  changing the location in the 'library' statement at the top of the program.          */
/*****************************************************************************************/
