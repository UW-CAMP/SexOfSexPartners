...
/*  formatted and labeled SAS dataset. The ASCII format dataset can be obtained here:   */
/*  https://www.cdc.gov/healthyyouth/data/yrbs/sadc_2019/sadc_2019_national.dat         */
/*                                                                                      */
/*  Change the file location specifications from 'H:\mpbarry\data' to the location      */
...
/*  top of the program.                                                                 */
/*                                                                                      */
/*  Note: Run 'YRBS SAS Formats.sas' BEFORE you run                                     */
/*  'YRBS SAS Input.sas' to create the 2019 SADC dataset.                               */
/****************************************************************************************/
 
filename datain 'H:\mpbarry\data\sadc_2019_national.dat';
...
/******************************************/
proc export data=library.yrbs
    outfile="'H:\mpbarry\data\yrbs.csv"
    dbms=csv;
run;
